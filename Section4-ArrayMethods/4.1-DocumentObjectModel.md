...
#### Practice selecting DOM elements: [4.1.1-Evr-SelectingDOMElements.js](4.1-Activities\4.1.1-Evr-SelectingDOMElements.js)
...
#### Practice navigating node relationships: [4.1.2-Stu-NodeRelationships.js](4.1-Activities\4.1.2-Stu-NodeRelationships.js)
...
#### Practice changing DOM elements: [4.1.3-Evr-ChangingElements.js](4.1-Activities\4.1.3-Evr-ChangingElements.js)
...
#### Practice creating elements: [4.1.4-Stu-CreatingElements.js](4.1-Activities\4.1.4-Stu-CreatingElements.js)
...
#### Practice with event listeners: [4.1.5-Evr-EventListeners.js](4.1-Activities\4.1.5-Evr-EventListeners.js)
