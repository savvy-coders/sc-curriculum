...
We will briefly look at the concepts of ...
...
Programming is constructing code that tells a computer what to do. Modern code is written in human-friendly languages that are compiled into 1s and 0s for computer hardware to understand.

We learned about "Coffee" & "Ham", and that JavaScript is the most powerful and flexible language today. JS can be used to code the full stack in a development environment.

ECMA International establishes the standards for the latest version of JavaScript also called ECMA Script.
