...
---
### **Exercise 1 (Everyone)**
#### Quick Practice with Mathematical Operators: [1-Evr-MathOperators.js](3-Activities\1-Evr-MathOperators.js)
---
...
---
### **Exercise 2 (Everyone)**
#### Introduction to Data Coercion: [2-Evr-DataCoercionIntro.js](3-Activities\2-Evr-DataCoercionIntro.js)
...
// ? TO DO ? // add brief section on how to convert primitive types to other types?
...
---
### **Exercise 3 (Everyone)**
#### Practice with comparison operators: [3-Evr-ComparisonOperators.js](3-Activities\3-Evr-ComparisonOperators.js)
...
#### If...else statement example: [4-Ins-IfElseStatements.js](3-Activities\4-Ins-IfElseStatements.js)

---
### **Exercise 5 (Students)**
#### Practice with if...else statements: [5-Stu-MoreIfElseStatements.js](3-Activities\5-Stu-MoreIfElseStatements.js)
...
---
### **Exercise 6 (Students)**
#### Practice with truthy/falsy and logical operators: [6-Stu-TruthyFalsyAndLogicalOperators.js](3-Activities\6-Stu-TruthyFalsyAndLogicalOperators.js)
...
---
### **Exercise 7 (Students)**
#### Practice with while loops: [7-Stu-WhileLoops.js](3-Activities\7-Stu-WhileLoops.js)
...
---
### **Exercise 8 (Students)**
#### Practice with for loops: [8-Stu-ForLoops.js](3-Activities\8-Stu-ForLoops.js)
