...
#### Quick Practice with Mathematical Operators: [2.3.1-Evr-MathOperators.js](2.3-Activities\2.3.1-Evr-MathOperators.js)
...
#### Introduction to Data Coercion: [2.3.2-Evr-DataCoercionIntro.js](2.3-Activities\2.3.2-Evr-DataCoercionIntro.js)
...
#### Practice with comparison operators: [2.3.3-Evr-ComparisonOperators.js](2.3-Activities\2.3.3-Evr-ComparisonOperators.js)
...
#### If...else statement example: [2.3.4-Ins-IfElseStatements.js](2.3-Activities\2.3.4-Ins-IfElseStatements.js)
...
#### Practice with if...else statements: [2.3.5-Stu-MoreIfElseStatements.js](2.3-Activities\2.3.5-Stu-MoreIfElseStatements.js)
...
#### Practice with truthy/falsy and logical operators: [2.3.6-Stu-TruthyFalsyAndLogicalOperators.js](2.3-Activities\2.3.6-Stu-TruthyFalsyAndLogicalOperators.js)
...
#### Practice with while loops: [2.3.7-Stu-WhileLoops.js](2.3-Activities\2.3.7-Stu-WhileLoops.js)
...
#### Practice with for loops: [2.3.8-Stu-ForLoops.js](2.3-Activities\2.3.8-Stu-ForLoops.js)
