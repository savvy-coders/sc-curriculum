...
#### Practice with variables and primitive data types: [2.2.1-Evr-JSVariablesAndPrimitives.js](Activities/2.2-Activities/2.2.1-Evr-JSVariablesAndPrimitives.js)
...
#### More practice with variables and primitives: [2.2.2-Stu-JSVariablesAndPrimitives.js](Activities/2.2-Activities/2.2.2-Stu-JSVariablesAndPrimitives.js)
...
#### Practice with "empty" primitives and template literals: [2.2.3-Evr-JSMorePrimitives.js](Activities/2.2-Activities/2.2.3-Evr-JSMorePrimitives.js)
...
#### More practice with primitives and template literals: [2.2.4-Stu-JSMorePrimitives.js](Activities/2.2-Activities/2.2.4-Stu-JSMorePrimitives.js)
