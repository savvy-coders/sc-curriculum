...
- We could exchange our MongoDb database for Firestore or Postgres at any time, and the user consuming JSON from our API would never know. (You could read more about Google Firestore or PostgreSQL in the [Curriculum Addendum Section](AddendumOfResources/AddendumOfResources.md))
