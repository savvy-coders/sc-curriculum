...
Let's use the most popular of these packages, [`morgan`](https://github.com/expressjs/morgan). After installing `morgan`, you can replace our `app.use` with `morgan`'s logger:
