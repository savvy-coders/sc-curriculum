...
#### Refactor function expressions into declarations: [1-Stu-FunctionDeclaration.js](Activities/3.1-Activities/3.1.1-Stu-FunctionDeclaration.js)
...
#### Practice with function invocation: [2-Evr-FunctionInvocation.js](Activities/3.1-Activities/3.1.2-Evr-FunctionInvocation.js)
...
#### Practice with returns and short circuiting: [3-Evr-ReturnsAndShortCircuiting.js](Activities/3.1-Activities/3.1.3-Evr-ReturnsAndShortCircuiting.js)
...
#### Practice with parameters: [4-Evr-Parameters.js](Activities/3.1-Activities/3.1.4-Evr-Parameters.js)
...
#### Practice with functions and scope: [5-Stu-FunctionsAndScope.js](Activities/3.1-Activities/3.1.5-Stu-FunctionsAndScope.js)
...
#### Practice with callbacks: [6-Evr-Callbacks.js](Activities/3.1-Activities/3.1.6-Evr-Callbacks.js)
...
#### Practice with arrow syntax: [7-Stu-ArrowSyntax.js](Activities/3.1-Activities/3.1.7-Stu-ArrowSyntax.js)
